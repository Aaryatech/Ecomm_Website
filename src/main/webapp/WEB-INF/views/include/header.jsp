...
<header>
				...
				<div class="top_address">
					...
					<ul class="login_menu edit">
						<li><a href="#"><i class="fa fa-pencil"
							...
							<ul>
								<li><a href="${pageContext.request.contextPath}/"> Add New Address </a></li>
								<li><a href="${pageContext.request.contextPath}/addresslist"> Use Existing address</a></li>
							</ul></li>
					</ul>
				</div>
				<div class="clr"></div>
	...
	<div class="logo_row">
		<div class="wrapper">
			<div class="menu_cont">
				<div class="main_logo">
					<a href="${pageContext.request.contextPath}/home"><img src="#" class="lazy"
