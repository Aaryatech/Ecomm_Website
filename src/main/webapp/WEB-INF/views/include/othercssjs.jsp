...
<meta name="keywords" content="Monginis only uses the finest ingredients in its products, ensuring the goods that we send out into the market"/>
<meta name="description" content="Monginis only uses the finest ingredients in its products, ensuring the goods that we send out into the market "/>
<meta name="author" content="Monginis only uses the finest ingredients in its products, ensuring the goods that we send out into the market">
