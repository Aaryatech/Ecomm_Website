...
public class CustomerAddDetail {
	...
	// Mahendra 27-11-2020
	// Desc-Get all customers address for website address list page
	...
	public String toString() {
		return "CustomerAddDetail [custDetailId=" + custDetailId + ", caption=" + caption + ", landmark=" + landmark
				...
				+ exVar1 + ", exVar2=" + exVar2 + ", exVar3=" + exVar3 + ", cityName=" + cityName + ", areaName="
				+ areaName + ", custName=" + custName + ", custMobileNo=" + custMobileNo + "]";
	}
