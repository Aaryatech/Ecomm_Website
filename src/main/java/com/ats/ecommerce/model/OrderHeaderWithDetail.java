...
public class OrderHeaderWithDetail {
	...
	public List<OrderDetailForConfirmation> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<OrderDetailForConfirmation> detailList) {
		this.detailList = detailList;
	}

	@Override
	public String toString() {
		return "OrderHeaderWithDetail [id=" + id + ", orderId=" + orderId + ", orderNo=" + orderNo + ", orderDate="
				...
				+ ", frName=" + frName + ", detailList=" + detailList + "]";
	}
