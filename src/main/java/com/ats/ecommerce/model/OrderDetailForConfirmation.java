...
public class OrderDetailForConfirmation {
	...
	public String toString() {
		return "OrderDetailForConfirmation [orderDetailId=" + orderDetailId + ", orderId=" + orderId + ", itemId="
				+ itemId + ", hsnCode=" + hsnCode + ", qty=" + qty + ", mrp=" + mrp + ", rate=" + rate + ", taxableAmt="
				...
				+ itemName + ", itemPic=" + itemPic + ", rateSettingType=" + rateSettingType + ", filterName="
				+ filterName + "]";
	}
